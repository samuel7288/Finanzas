...
export const iconPaths = {
  ...
  edit: "M4 20h4l10-10-4-4L4 16v4 M13 7l4 4",
  help: "M12 18h.01 M9.1 9a3 3 0 1 1 5.6 1.4c-.5.8-1.2 1.2-1.9 1.7-.8.5-1.4 1.1-1.4 2.4",
  camera: "M4 8h3l1.4-2h7.2L17 8h3v10H4z M12 10a4 4 0 1 0 0 8 4 4 0 0 0 0-8z",
  lock: "M7 11V8a5 5 0 1 1 10 0v3 M6 11h12v9H6z",
  shield: "M12 3l7 3v5c0 5-3.5 8-7 10-3.5-2-7-5-7-10V6z M9.5 12.5l1.8 1.8 3.7-4.3",
  devices: "M4 6h16v10H4z M8 20h8 M10 16v4 M6 9h12",
  utensils: "M6 3v8 M9 3v8 M6 7h3 M15 3v18 M15 3c2 0 3 2 3 4s-1 4-3 4",
  car: "M5 14l1.5-4h11L19 14 M7 14h10 M8 17a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3z M16 17a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3z",
  playCircle: "M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18z M10 9l5 3-5 3z",
  zap: "M13 2 6 13h5l-1 9 7-11h-5z",
  heart: "M12 20s-7-4.4-7-10a4 4 0 0 1 7-2.5A4 4 0 0 1 19 10c0 5.6-7 10-7 10z",
  bag: "M7 8V6a5 5 0 0 1 10 0v2 M5 8h14v12H5z",
  book: "M5 5.5A2.5 2.5 0 0 1 7.5 3H19v16H7.5A2.5 2.5 0 0 0 5 21z M5 5.5v15 M9 7h6",
  warning: "M12 3 21 19H3z M12 9v4 M12 17h.01",
  copy: "M9 9h10v12H9z M5 15H4V3h10v2",
